...
export function useFlex76Cb() {
	const onClick = useCallback(callbackFactory("Flex76", "Home", "/", "onClick", 
			{
  "handlers": [],
  "actions": [
    {
...
export function useFlex128Cb() {
	const onClick = useCallback(callbackFactory("Flex128", "Home", "/", "onClick", 
			{
  "handlers": [],
  "actions": [
    {
...
export function useTextBox107Cb() {
	const onClick = useCallback(callbackFactory("TextBox107", "Home", "/", "onClick", 
			{
  "handlers": [
    {
      "sendEventData": true
...
export function useFlex137Cb() {
	const onClick = useCallback(callbackFactory("Flex137", "Home", "/", "onClick", 
			{
  "handlers": [],
  "actions": [
    {
